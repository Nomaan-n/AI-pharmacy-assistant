...
_worker_task=None
CURATED=[
 {"name":"Paracetamol","category":"Pain & fever","uses":["Fever","Mild to moderate pain"],"warning":"Do not exceed the product-label dose. Too much can seriously damage the liver.","tip":"Check combination cold or pain medicines for paracetamol."},
 {"name":"Ibuprofen","category":"Pain & inflammation","uses":["Pain","Fever","Inflammation"],"warning":"NSAIDs can cause stomach, kidney and cardiovascular problems in some people.","tip":"Ask a pharmacist if you have ulcers, kidney disease, heart disease, take blood thinners, or are pregnant."},
 {"name":"Cetirizine","category":"Allergy relief","uses":["Sneezing","Runny nose","Itching"],"warning":"Some people become sleepy or less alert.","tip":"See how it affects you before driving."},
 {"name":"Loratadine","category":"Allergy relief","uses":["Sneezing","Runny nose","Itching"],"warning":"Drowsiness can occur in some people.","tip":"Check the label and other medicines with a pharmacist."},
 {"name":"Omeprazole","category":"Acid reflux","uses":["Heartburn","Acid reflux"],"warning":"Persistent or severe symptoms need professional assessment.","tip":"Use according to product instructions or professional advice."},
 {"name":"Amoxicillin","category":"Antibiotic","uses":["Certain bacterial infections"],"warning":"It does not treat viral illnesses. Serious allergic reactions are possible.","tip":"Use antibiotics only when appropriately prescribed or supplied."},
 {"name":"Metformin","category":"Diabetes medicine","uses":["Type 2 diabetes","Blood glucose control"],"warning":"Suitability and dosing depend on the individual.","tip":"Take exactly as prescribed."},
 {"name":"Atorvastatin","category":"Cholesterol medicine","uses":["Lowering cholesterol","Reducing cardiovascular risk"],"warning":"Unexplained severe muscle pain or weakness should be assessed promptly.","tip":"Tell your clinician about other medicines and supplements."},
]
@asynccontextmanager
...
app=FastAPI(lifespan=lifespan,title="AI Pharmacy Assistant",version="4.0.0",description="Safety-first medication information and verification assistant.")
...
async def request_observability(request:Request,call_next):
    rid=request.headers.get("X-Request-ID") or uuid.uuid4().hex; started=time.perf_counter(); response=await call_next(request); response.headers["X-Request-ID"]=rid
